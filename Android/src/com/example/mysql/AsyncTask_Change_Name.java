...
public class AsyncTask_Change_Name extends AsyncTask<String, String, String> {

	JSONParser jsonParser = new JSONParser();
	private static String url_up = Config_mysql.mysql_url_change_name;
	Context context;
	ProgressDialog dialog;

	public AsyncTask_Change_Name(Context context) {
	...
	protected String doInBackground(String... p) {
		...
		params.add(new BasicNameValuePair("user_name", p[1]));
		try {
