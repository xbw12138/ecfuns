...
public class AsyncTask_Search_Single_Talk extends AsyncTask<String, String, String> {
	JSONParsers jsonParser = new JSONParsers();
	private static String url_up = Config_mysql.mysql_url_search_single_talk;
	Context context;
	ProgressDialog dialog;
	List<ListTalkModel> list = new ArrayList<ListTalkModel>();

	public AsyncTask_Search_Single_Talk(Context context) {
