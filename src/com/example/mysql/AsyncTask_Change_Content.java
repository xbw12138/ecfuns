...
public class AsyncTask_Change_Content extends AsyncTask<String, String, String> {
	JSONParser jsonParser = new JSONParser();
	private static String url_up = Config_mysql.mysql_change_content;
	Context context;
	ProgressDialog dialog;

	public AsyncTask_Change_Content(Context context) {
	...
	protected String doInBackground(String... p) {
		...
		String message = null;
		params.add(new BasicNameValuePair("qr_url", p[0]));
		params.add(new BasicNameValuePair("qr_content", p[1]));
		try {
