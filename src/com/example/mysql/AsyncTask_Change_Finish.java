...
public class AsyncTask_Change_Finish extends AsyncTask<String, String, String>{
	JSONParser jsonParser = new JSONParser();
	private static String url_up = Config_mysql.mysql_change_finish;
	Context context;
	ProgressDialog dialog;
	public AsyncTask_Change_Finish(Context context) {
...
dialog.show();
	...
	protected String doInBackground(String... p) {
		...
		String message=null;
	    params.add(new BasicNameValuePair("qr_id", p[0]));
	    params.add(new BasicNameValuePair("is_finish", p[1]));
	    params.add(new BasicNameValuePair("user_phone", p[2]));
	       try{
